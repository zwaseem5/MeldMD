...
export default function Solutions() {
  ...
  const solutions = [
    {
      ...
      description: 'Revolutionary telehealth solution with AI-powered diagnostics, white-label options, and comprehensive patient engagement tools.',
      features: [
  ...
  const benefits = [
    {
      ...
      description: 'Machine learning algorithms optimize every aspect of healthcare delivery for superior outcomes.',
      icon: 'ri-robot-line',
    ...
    },
    {
      ...
      description: 'Next-generation encryption and quantum-resistant security protocols protect all data.',
    ...
    },
    {
      ...
      description: 'Cloud-native architecture enables instant scaling across multiple regions and jurisdictions.',
      icon: 'ri-global-line',
      gradient: 'from-emerald-400 via-teal-500 to-cyan-600',
      stats: '50+ Countries'
    },
    {
      ...
      description: 'Advanced algorithms predict patient needs and optimize treatment protocols proactively.',
  ...
  return (
    <div className="pt-16" ref={containerRef}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {[...Array(6)].map((_, i) => (
            ...
            >
              <i className={`ri-${['hospital-line', 'capsule-line', 'smartphone-line', 'shield-check-line', 'user-heart-line', 'microscope-line'][i]} text-5xl`}></i>
            </motion.div>
          ))}
        </div>
      ...
      {/* Solutions Grid with Advanced Design */}
      <section id="solutions" className="relative py-32 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl animate-spin" style={{ animationDuration: '20s' }} />
        </div>
              ...
              >
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  ...
                  >
                    ...
                    />
                    <div className={`absolute inset-0 bg-gradient-to-t ${solution.gradient} opacity-30`}></div>
                    ...
                    >
                      <div className={`w-20 h-20 bg-gradient-to-br ${solution.gradient} rounded-2xl flex items-center justify-center shadow-2xl backdrop-blur-sm`}>
                  ...
                  >
                    ...
                    <div className="space-y-4 mb-8">
                      {solution.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div className={`w-3 h-3 bg-gradient-to-r ${solution.gradient} rounded-full mr-4 shadow-lg`}></div>
